...
--------------------------------------------------------------------------------
-- these things will be used by the ui to perform authoritive tasks on the server
...
-- pushes the command to update inventory to the server.
...
-- pushes the command to consume inventory to the server.
...
--------------------------------------------------------------------------------
-- these will deal with each individual weapon on the turret -----------
...
-- bumps the mark names on weapons. we do this mainly to trick the game into
...
-- gets how many guns are on this turret.
...
-- determines if we have edited a turret before.
...
-- determines if this turret should be allowed to have its damage unnerfed.
