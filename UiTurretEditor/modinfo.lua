...
meta =
{
    ...
    name = "[beta] UiTurretEditor",

    -- Title of your mod that will be displayed to players
    title = "[beta] UiTurretEditor",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "This is a UiTurretEditor remake/updated and stable version for 2.0 beta as the game keeps updating ill keep updating it to make it stable.this mod allows you to customize turrets salvage and even upgrade your current turrets!!",

    -- Insert all authors into this list
    authors = {"GLOGang3hunna"},
    ...
    contact = "GLOGang3hunna#7131 on discord",
}
